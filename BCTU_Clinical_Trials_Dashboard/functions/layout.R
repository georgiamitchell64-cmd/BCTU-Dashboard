...
build_app_ui <- function() {
  fluidPage(
    ...
    tags$head(
      ...
      # Dark mode (generated by tools/build_dark_theme.R). Loads before
      # modules_redesign.css so its hand-written dark rules still win.
      tags$link(rel = "stylesheet", type = "text/css", href = .asset("dark_theme.css")),
      tags$script(src = .asset("dark_theme.js"), defer = NA),
      tags$script(src = .asset("dark_palette.js")),
      ...
      # Guided tours and help pop-ups (functions/tutorial.R)
      tutorial_assets(),
            ...
            div(class = "topbar-right",
                ...
                div(id = "topbar_account", class = "topbar-account",
                    ...
                    div(class = "topbar-acct-menu",
                        ...
                        tags$button(class = "tam-item", type = "button",
                                    onclick = "bctuTour.replay()",
                                    HTML('<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.1 9a3 3 0 0 1 5.8 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>'),
                                    span("Take the tour")),
