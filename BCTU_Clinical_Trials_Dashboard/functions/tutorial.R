...
TOURS <- list(
  ...
  home = list(steps = list(
    ...
    .tour_step(target = "#my_trials_table",
      "Your trials",
      paste0("One tile per trial, with recruitment against target and the sites open. ",
             "<b>Click a tile</b> to open that trial's dashboard.")),
    .tour_step(target = "#home_tab_my .mt-toolbar",
      "Find a trial",
      "Search by trial, chief investigator or sponsor, or narrow the list to one category."),
    .tour_step(target = ".home-topbar .home-settings",
      "Settings",
      paste0("Switch between light and dark, and turn on the optional <b>Portfolio</b> and ",
             "<b>All Trials</b> tabs. Admins manage people and access here too.")),
