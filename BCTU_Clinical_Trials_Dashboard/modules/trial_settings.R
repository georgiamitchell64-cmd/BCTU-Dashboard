        ...
        div(class = "settings-body",
          ...
          .st_sec("profile", first = TRUE,
            ...
            .st_card("Portfolio review", "Trial-level facts for the BCTU Trial Update Summary. Meeting dates and RAG status are entered on the Reports tab.",
              ...
              div(class = "form-grid",
                  .st_field("Grant start date", dateInput("pr_grant_start", NULL, value = NULL, format = "dd M yyyy", width = "100%")),
                  .st_field("Grant end date", dateInput("pr_grant_end", NULL, value = NULL, format = "dd M yyyy", width = "100%")),
                  .st_field("First patient recruited", dateInput("pr_first_patient_date", NULL, value = NULL, format = "dd M yyyy", width = "100%")),
                  .st_field("All approvals in place", dateInput("pr_approvals_date", NULL, value = NULL, format = "dd M yyyy", width = "100%")),
                  .st_field("Open to recruitment", dateInput("pr_open_recruitment_date", NULL, value = NULL, format = "dd M yyyy", width = "100%")),
