      ...
      tags$main(class = "settings-main",
        ...
        div(class = "settings-body",
          ...
          .st_sec("data",
            ...
            .st_card("Demographics", "Which demographic breakdowns appear on the Data tab, and the names shown for each coded value.",
          ...
          .st_sec("reports",
            ...
            .st_card("Report templates", "Edit this trial's TMG/iTMG and TSC report templates. Saved templates live in the trial's reports folder.",
