 ...
 * standard account on a managed machine does not hold. See win.signAndEditExecutable
 * in package.json and the icon section of the README.
 *
  ...
  try {
    await rcedit(exePath, {
      ...
      'version-string': {
        ...
        CompanyName: 'Birmingham Clinical Trials Unit',
        LegalCopyright: `© ${new Date().getFullYear()} Birmingham Clinical Trials Unit`,
